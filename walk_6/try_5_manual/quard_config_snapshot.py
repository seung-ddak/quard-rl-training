...
class QuardWalk6Cfg(_QuardCommonCfg):
    ...
    class rewards(_QuardCommonCfg.rewards):
        ...
        class scales(_QuardCommonCfg.rewards.scales):
            ...
            collision = -15.0
            # try_4: shuffle 차단 - slip 페널티 강화 (-2.0→-5.0)
            feet_slip = -5.00
            # try_4: rear도 동일 (-1.35→-3.50)
            rear_feet_slip = -3.50
            feet_stumble = -2.40
            stand_when_should_walk = -1.60
            tripod_penalty = -2.30
...
class QuardWalk6CfgPPO(_QuardCommonCfgPPO):
    ...
    class runner(_QuardCommonCfgPPO.runner):
        ...
        max_iterations = 2000
        resume = True
        # try_5: walk_6 try_4 final ckpt resume.
        load_run = "/mnt/gstore/home/xiangyue/RL/legged_gym/logs/walk_6/Apr18_16-05-41_walk_6"
        checkpoint = 13950
