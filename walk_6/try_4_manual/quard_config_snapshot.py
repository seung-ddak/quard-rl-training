...
class QuardWalk6Cfg(_QuardCommonCfg):
    ...
    class rewards(_QuardCommonCfg.rewards):
        ...
        # try_4 신규: cycle-based swing target
        ...
        class scales(_QuardCommonCfg.rewards.scales):
            ...
            tracking_ang_vel = 1.00
            feet_air_time = 2.40
            # try_4: legacy swing_height scale 8.0→3.0 (보조 신호로 격하)
            swing_height = 3.00
            diagonal_gait = 2.00
            ...
            # try_4 신규 — touchdown event-based swing 보상 (plateau 돌파 주력)
            swing_cycle_peak = 4.00
...
class QuardWalk6CfgPPO(_QuardCommonCfgPPO):
    ...
    class runner(_QuardCommonCfgPPO.runner):
        ...
        max_iterations = 2000
        resume = True
        # try_4: walk_6 try_3 final ckpt resume (직진/추진/대칭/대각 모두 보존,
        # swing_height plateau만 신규 reward로 돌파)
        load_run = "/mnt/gstore/home/xiangyue/RL/legged_gym/logs/walk_6/Apr18_14-26-16_walk_6"
        checkpoint = 11950
